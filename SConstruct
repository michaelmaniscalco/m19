...
#===============================================================================
common_compiler_flags = ['-std=c++11', '-rdynamic', '-pipe', '-Wall', '-Wextra', '-Wno-unused-function', '-fPIC', '-fstrict-aliasing']
...
release_compiler_flags = ['-O3', '-march=native', '-fno-stack-protector', '-funroll-loops', '-funsafe-loop-optimizations', '-pthread']
